...
<head>
  ...
  <!-- Morris chart -->
  <link rel="stylesheet" href="${path}/bower_components/morris.js/morris.css">
  <!-- jvectormap -->
  <link rel="stylesheet" href="${path}/bower_components/jvectormap/jquery-jvectormap.css">
  <!-- Date Picker -->
  <link rel="stylesheet" href="${path}/bower_components/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css">
  <!-- Daterange picker -->
  <link rel="stylesheet" href="${path}/bower_components/bootstrap-daterangepicker/daterangepicker.css">
      ...
      <div class="row">
        ...
        <section class="col-lg-7 connectedSortable">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <!-- See ${path}/dist/js/pages/dashboard.js to activate the todoList plugin -->
              <ul class="todo-list">
                <li>
                  <!-- drag handle -->
                  <span class="handle">
...
<!-- jQuery UI 1.11.4 -->
<script src="${path}/bower_components/jquery-ui/jquery-ui.min.js"></script>
...
<!-- Morris.js charts -->
<script src="${path}/bower_components/raphael/raphael.min.js"></script>
<script src="${path}/bower_components/morris.js/morris.min.js"></script>
<!-- Sparkline -->
...
<!-- jQuery Knob Chart -->
<script src="${path}/bower_components/jquery-knob/dist/jquery.knob.min.js"></script>
<!-- daterangepicker -->
<script src="${path}/bower_components/moment/min/moment.min.js"></script>
<script src="${path}/bower_components/bootstrap-daterangepicker/daterangepicker.js"></script>
<!-- datepicker -->

  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        <li class="header">推荐位设置</li>
        <li class="treeview">
          <a href="#"><i class="fa fa-sitemap"></i> <span>网页设计</span>
            <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
          </a>
          <ul class="treeview-menu">
              <li><a href="#" onclick="javascript:loadWebDesin();"><i class="fa fa-circle-o"></i> 页面设计</a></li>
              <li><a href="#" onclick="javascript:loadWebDesin1();"><i class="fa fa-circle-o"></i> 添加推荐位</a></li>
          </ul>
        </li>
        <li class="header">专题及自动任务管理</li>
      </ul>
      <!-- /.sidebar-menu -->
    </section>
    <!-- /.sidebar -->
...
<script type="text/javascript">
    ...
    function loadWebDesin(){
        $.post(
            "${path}/freemarkerCtr/webDesign",
            function(data){
    ...
    function loadWebDesin1(){
        $.post(
                "${path}/freemarkerCtr/webDesign",
                function(data){
                    $(".content.container-fluid").html(1234);
                }
        );
        $(".treeview-menu > li").removeClass("active");
